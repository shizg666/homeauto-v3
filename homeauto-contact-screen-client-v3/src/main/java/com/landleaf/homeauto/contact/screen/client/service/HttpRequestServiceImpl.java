...
public class HttpRequestServiceImpl implements HttpRequestService {
    ...
    private ContactScreenHttpResponse handleRequest(String url, Object requestDTO, String screenMac) {
        ...
        ContactScreenHttpResponse contactScreenHttpResponse = restTemplateClient.postForObject(URL_PRE_PROD.concat(url), requestDTO, new TypeReference<ContactScreenHttpResponse>() {
        });
