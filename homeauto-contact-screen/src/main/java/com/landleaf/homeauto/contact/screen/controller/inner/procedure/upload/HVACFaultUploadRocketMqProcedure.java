 ...
 */
@Component
public class HVACFaultUploadRocketMqProcedure extends AbstractUploadRocketMqProcedure {
    ...
    public void procedureMessage(ScreenMqttUploadBaseDTO screenUploadBaseDTO) {
        ...
        mqProducerSendMsgProcessor.send(RocketMqConst.TOPIC_CONTACT_SCREEN_TO_CENTER_ADAPTER, RocketMqConst.HVAC_FAULT_UPLOAD, JSON.toJSONString(screenUploadBaseDTO));
