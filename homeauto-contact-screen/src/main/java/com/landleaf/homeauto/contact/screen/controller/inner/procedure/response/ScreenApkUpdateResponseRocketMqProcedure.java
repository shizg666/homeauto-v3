 ...
 */
@Component
public class ScreenApkUpdateResponseRocketMqProcedure extends AbstractResponseRocketMqProcedure {
    @Autowired
    ...
    public void procedureMessage(ScreenMqttResponseBaseDTO screenResponseBaseDTO) {
        mqProducerSendMsgProcessor.send(RocketMqConst.TOPIC_CONTACT_SCREENC_TO_ENTER_ADAPTER, RocketMqConst.TAG_SCREEN_APK_UPDATE, JSON.toJSONString(screenResponseBaseDTO));
    }
}
