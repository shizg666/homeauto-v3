 ...
 * @author wenyilu
 */
@RocketMQConsumeService(topic = RocketMqConst.TOPIC_WEBSOCKET_TO_ENTER_ADAPTER, tags = RocketMqConst.TAG_DEVICE_WRITE)
@Slf4j
public class DeviceWriteRocketMqConsumer extends AbstractMQMsgProcessor {
    ...
    protected MQConsumeResult consumeMessage(String tag, List<String> keys, MessageExt message) {
        try {
            ...
            AdapterDeviceControlDTO requestDto = JSON.parseObject(msgBody, AdapterDeviceControlDTO.class);
