...
//            }
//        }
//        Map<String,Object> dataCache = Maps.newHashMapWithExpectedSize(data.size());
...
//                }
//            }
//            dataCache.put(String.format(RedisCacheConst.PRODUCT_ERROR_INFO, obj.getProductCode(), obj.getCode()), JSON.toJSONString(obj));
//        }
//        redisUtils.pipelineInsert(dataCache);
//    }
//}
