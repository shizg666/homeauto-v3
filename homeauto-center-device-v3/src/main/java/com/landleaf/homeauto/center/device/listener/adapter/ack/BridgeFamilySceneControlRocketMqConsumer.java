...
@RocketMQConsumeService(topic = RocketMqConst.TOPIC_CENTER_ADAPTER_TO_APP,
        tags = RocketMqConst.TAG_FAMILY_SCENE_SET)
@Slf4j
public class BridgeFamilySceneControlRocketMqConsumer extends AbstractMQMsgProcessor {
    ...
    protected MQConsumeResult consumeMessage(String tag, List<String> keys, MessageExt message) {
        try {
            ...
            AdapterSceneControlAckDTO ackDTO = JSON.parseObject(msgBody,AdapterSceneControlAckDTO.class);
