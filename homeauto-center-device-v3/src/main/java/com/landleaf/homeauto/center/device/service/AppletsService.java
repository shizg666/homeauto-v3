...
public interface AppletsService {
     ...
     */
    AppletsDeviceInfoVO getDeviceStatus4AppletsVO(Long familyId, Long deviceId);
    /**
     *  小程序查看定时场景信息
     * @param timingId
     ...
     */
    AppletsSceneTimingDetailVO getTimingSceneDetail4Applets(Long timingId);
    /**
     * 小程序我的家庭-获取楼层房间设备信息
    ...
    AppletsDeviceInfoVO getSystemStatus4AppletsVO(Long familyId);
}
