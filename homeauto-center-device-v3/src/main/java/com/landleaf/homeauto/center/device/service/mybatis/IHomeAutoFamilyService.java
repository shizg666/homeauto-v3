...
public interface IHomeAutoFamilyService extends IService<HomeAutoFamilyDO> {
     ...
     * @return
     */
    BasePageVO<DeviceMangeFamilyPageVO2> getListDeviceMangeFamilyPage2(List<Long> familyIds, String deviceName,String categoryCode, Integer onlineFlag, Integer pageSize, Integer pageNum);
     ...
     * @param terminalMac
     */
    void bindMac(Long projectId, String buildingCode, String unitCode, String doorplate, String terminalMac);
