 ...
 */
@Data
public class SobotExtendFieldDTO {
    ...
    @ApiModelProperty(value = "选择型字段的选项信息", name = "field_data_list", required = true, notes = "")
    private List<SobotExtendFieldDataDTO> field_data_list;
