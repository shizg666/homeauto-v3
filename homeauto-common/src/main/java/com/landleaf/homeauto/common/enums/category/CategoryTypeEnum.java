...
//	VIDEO_INTERCOM(6,"video_intercom","可视对讲",""),
	...
	CategoryTypeEnum(Integer type , String nameEn, String name, String icon) {
		this.type = type;
		this.nameEn = nameEn;
		this.name = name;
		this.icon = icon;
	...
	private static Map<Integer, CategoryTypeEnum> map = null; // type, enum映射
	private static boolean isInit = false;
	public static CategoryTypeEnum getInstByType(Integer type){
		if(type==null){
			return null;
		}
		if(!isInit){
