...
public class ShReflectionUtil {
    ...
    private static Logger logger = LoggerFactory.getLogger(ShReflectionUtil.class);
    ...
    public static void setFieldValue2(Object obj, String fieldPath, Object value) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, InstantiationException {
        int pos = -1;
        if (fieldPath.contains(CommonConst.SymbolConst.SPOT)) {
            pos = fieldPath.indexOf(CommonConst.SymbolConst.SPOT);
        }
        if (pos != -1) {
